...
PGDATABASE=saltcorn_test saltcorn build-app -p web -e dashboard -t page -b /tmp/saltcorn_build -u admin@foo.com -s http://localhost:3010 --allowOfflineMode  --synchedTables guitars processed process_type --includedPlugins any-bootstrap-theme flatpickr-date
