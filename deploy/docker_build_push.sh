...
docker build -t saltcorn/capacitor-builder:latest -f packages/saltcorn-mobile-builder/docker/Dockerfile packages/saltcorn-mobile-builder/docker
docker push saltcorn/capacitor-builder:latest
