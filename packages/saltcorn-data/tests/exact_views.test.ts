...
<button type="submit"  class=" btn  btn-primary ">Delete</button></form></div>`,
  ...
  it("should render double join embedded exactly", async () => {
    ...
    await test_show({
      ...
      response: `<div class="row w-100"><div class="col-2">Author</div><div class="col-10">Herman Melville</div></div><br /><div class="row w-100"><div class="col-2">Pages</div><div class="col-10">967</div></div><br /><div class="row w-100"><div class="col-2">Publisher</div><div class="col-10"><h3></h3></div></div><br /><div class="table-responsive"><table class="table table-sm"><thead><tr><th><span onclick="sortby('date', false, '8e146', this)" class="link-style">Date</span></th><th><span onclick="sortby('normalised', false, '8e146', this)" class="link-style">Normalised</span></th><th>name</th><th style="text-align: right;"><span onclick="sortby('temperature', false, '8e146', this)" class="link-style">Temperature</span></th></tr></thead><tbody><tr><td><time datetime="2019-11-11T10:34:00.000Z" locale-date-options="%7B%7D">11/11/2019</time></td><td><i class="fas fa-lg fa-check-circle text-success"></i></td><td>Kirk Douglas</td><td style="text-align:right">37</td></tr><tr><td></td><td><i class="fas fa-lg fa-times-circle text-danger"></i></td><td>Kirk Douglas</td><td style="text-align:right">39</td></tr></tbody></table></div>`,
    });
  });
});
describe("Edit view", () => {
