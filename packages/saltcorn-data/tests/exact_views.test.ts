  ...
  it("should render masonry exactly", async () => {
    await test_feed({
      ...
      response: !remoteQueries
        ...
        : `<div><a href="javascript:execLink('/view/authoredit');">New book</a><div class="card-columns"><div class="card shadow mt-2"><div class="card-body"><form data-viewname="authoredit" action="/view/authoredit" class="form-namespace " method="post"><input type="hidden" name="_csrf" value=""><input type="hidden" class="form-control  " name="id" value="2"><input type="text" class="form-control  " data-fieldname="author" name="author" required id="inputauthor" value="Leo Tolstoy"></form></div></div><div class="card shadow mt-2"><div class="card-body"><form data-viewname="authoredit" action="/view/authoredit" class="form-namespace " method="post"><input type="hidden" name="_csrf" value=""><input type="hidden" class="form-control  " name="id" value="1"><input type="text" class="form-control  " data-fieldname="author" name="author" required id="inputauthor" value="Herman Melville"></form></div></div></div></div>`,
    });
  });
});
