...
describe("MJML Mail Transformations", () => {
  it("transform simple to mjml", async () => {
    ...
    expect(ml).toBe(
      `<mjml><mj-head><mj-attributes><mj-section padding-top=\"0px\" padding-bottom=\"0px\"></mj-section><mj-text padding-top=\"0px\" padding-bottom=\"0px\"></mj-text></mj-attributes><mj-raw><link href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css\" rel=\"stylesheet\"></mj-raw></mj-head><mj-body><mj-section><mj-raw><div style=\"text-align: left !important; font-size: 16px;\"><table width="100%" style="margin-bottom:1rem"><tr><td width="25%">Author</td><td width="75%">Herman Melville</td></tr></table><table width="100%" style="margin-bottom:1rem"><tr><td width="25%">Pages</td><td width="75%">967</td></tr></table><table width="100%" style="margin-bottom:1rem"><tr><td width="33%"><a href="/view/authoredit?id=1">Edit</a></td><td width="33%"><form action="/delete/books/1?redirect=/view/authorshow" method="post" class="d-inline">
  <input type="hidden" name="_csrf" value="">
<button type="submit"  class=" btn  btn-primary ">Delete</button></form></td><td width="33%">1</td></tr></table></div></mj-raw></mj-section></mj-body></mjml>`
    );
  });
  it("transform simple to html", async () => {
    ...
    expect(trimLines(html)).toBe(
      ...
      <![endif]--><style type="text/css"></style><style type="text/css"></style><link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" rel="stylesheet"></head><body style="word-spacing:normal;"><div><!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]--><div style="margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:0px;text-align:center;"><!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><![endif]--><div style="text-align: left !important; font-size: 16px;"><table width="100%" style="margin-bottom:1rem"><tr><td width="25%">Author</td><td width="75%">Herman Melville</td></tr></table><table width="100%" style="margin-bottom:1rem"><tr><td width="25%">Pages</td><td width="75%">967</td></tr></table><table width="100%" style="margin-bottom:1rem"><tr><td width="33%"><a href="/view/authoredit?id=1">Edit</a></td><td width="33%"><form action="/delete/books/1?redirect=/view/authorshow" method="post" class="d-inline"><input type="hidden" name="_csrf"> <button type="submit" class="btn btn-primary">Delete</button></form></td><td width="33%">1</td></tr></table></div><!--[if mso | IE]></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><![endif]--></div></body></html>`)
    );
  });
