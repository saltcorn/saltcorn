...
@saltcorn/cli/0.8.0-beta.3 darwin-arm64 node-v16.18.1
...
_See code: [src/commands/add-schema.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/add-schema.js)_
...
_See code: [src/commands/backup.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/backup.js)_
...
_See code: [src/commands/build-app.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/build-app.js)_
...
_See code: [src/commands/configuration-check.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/configuration-check.js)_
...
_See code: [src/commands/configuration-check-backups.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/configuration-check-backups.js)_
...
_See code: [src/commands/create-tenant.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/create-tenant.js)_
...
_See code: [src/commands/create-user.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/create-user.js)_
...
_See code: [src/commands/delete-tenants.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/delete-tenants.js)_
...
_See code: [src/commands/delete-user.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/delete-user.js)_
...
_See code: [src/commands/fixtures.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/fixtures.js)_
...
_See code: [src/commands/get-cfg.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/get-cfg.js)_
...
_See code: [src/commands/info.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/info.js)_
...
_See code: [src/commands/inspect.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/inspect.js)_
...
_See code: [src/commands/install-pack.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/install-pack.js)_
...
_See code: [src/commands/install-plugin.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/install-plugin.js)_
...
_See code: [src/commands/list-tenants.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/list-tenants.js)_
...
_See code: [src/commands/localize-plugin.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/localize-plugin.js)_
...
_See code: [src/commands/make-migration.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/make-migration.js)_
...
_See code: [src/commands/migrate.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/migrate.js)_
...
_See code: [src/commands/modify-user.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/modify-user.js)_
...
_See code: [src/commands/plugins.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/plugins.js)_
...
_See code: [src/commands/release.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/release.js)_
...
_See code: [src/commands/reset-schema.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/reset-schema.js)_
...
_See code: [src/commands/restore.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/restore.js)_
...
_See code: [src/commands/rm-tenant.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/rm-tenant.js)_
...
_See code: [src/commands/run-benchmark.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/run-benchmark.js)_
...
_See code: [src/commands/run-tests.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/run-tests.js)_
...
_See code: [src/commands/scheduler.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/scheduler.js)_
...
_See code: [src/commands/serve.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/serve.js)_
...
_See code: [src/commands/set-cfg.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/set-cfg.js)_
...
_See code: [src/commands/setup.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/setup.js)_
...
_See code: [src/commands/setup-benchmark.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/setup-benchmark.js)_
...
_See code: [src/commands/test-plugin.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/test-plugin.js)_
...
_See code: [src/commands/transform-field.js](https://github.com/saltcorn/saltcorn/blob/v0.8.0-beta.3/src/commands/transform-field.js)_
<!-- commandsstop -->
