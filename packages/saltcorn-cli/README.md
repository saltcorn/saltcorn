...
running command...
$ saltcorn (--version)
@saltcorn/cli/1.5.6 linux-x64 node-v24.14.1
...
_See code: [src/commands/add-schema.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/add-schema.js)_
...
_See code: [src/commands/backup.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/backup.js)_
...
_See code: [src/commands/build-app.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/build-app.js)_
...
_See code: [src/commands/build-capacitor-builder.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/build-capacitor-builder.js)_
...
_See code: [src/commands/configuration-check.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/configuration-check.js)_
...
_See code: [src/commands/configuration-check-backups.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/configuration-check-backups.js)_
...
_See code: [src/commands/create-tenant.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/create-tenant.js)_
...
_See code: [src/commands/create-user.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/create-user.js)_
...
_See code: [src/commands/delete-tenants.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/delete-tenants.js)_
...
_See code: [src/commands/delete-user.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/delete-user.js)_
...
_See code: [src/commands/dev/localize-plugin.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/localize-plugin.js)_
...
_See code: [src/commands/dev/make-migration.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/make-migration.js)_
...
_See code: [src/commands/dev/plugin-test.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/plugin-test.js)_
...
_See code: [src/commands/dev/post-release.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/post-release.js)_
...
_See code: [src/commands/dev/release.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/release.js)_
...
_See code: [src/commands/dev/release-resume.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/release-resume.js)_
...
_See code: [src/commands/dev/test-plugin.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/test-plugin.js)_
...
_See code: [src/commands/dev/translate.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/dev/translate.js)_
...
_See code: [src/commands/fixtures.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/fixtures.js)_
...
_See code: [src/commands/get-cfg.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/get-cfg.js)_
...
_See code: [src/commands/info.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/info.js)_
...
_See code: [src/commands/inspect.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/inspect.js)_
...
_See code: [src/commands/install-pack.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/install-pack.js)_
...
_See code: [src/commands/install-plugin.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/install-plugin.js)_
...
_See code: [src/commands/list-tenants.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/list-tenants.js)_
...
_See code: [src/commands/list-triggers.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/list-triggers.js)_
...
_See code: [src/commands/list-users.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/list-users.js)_
...
_See code: [src/commands/migrate.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/migrate.js)_
...
_See code: [src/commands/modify-user.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/modify-user.js)_
...
_See code: [src/commands/plugins.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/plugins.js)_
...
_See code: [src/commands/pre-install-modules.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/pre-install-modules.js)_
...
_See code: [src/commands/prepare.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/prepare.js)_
...
_See code: [src/commands/reset-schema.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/reset-schema.js)_
...
_See code: [src/commands/restore.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/restore.js)_
...
_See code: [src/commands/rm-tenant.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/rm-tenant.js)_
...
_See code: [src/commands/run-benchmark.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/run-benchmark.js)_
...
_See code: [src/commands/run-js.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/run-js.js)_
...
_See code: [src/commands/run-sql.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/run-sql.js)_
...
_See code: [src/commands/run-tests.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/run-tests.js)_
...
_See code: [src/commands/run-trigger.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/run-trigger.js)_
...
_See code: [src/commands/scheduler.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/scheduler.js)_
...
_See code: [src/commands/serve.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/serve.js)_
...
_See code: [src/commands/set-cfg.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/set-cfg.js)_
...
_See code: [src/commands/set-daily-time.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/set-daily-time.js)_
...
_See code: [src/commands/setup.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/setup.js)_
...
_See code: [src/commands/setup-benchmark.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/setup-benchmark.js)_
...
_See code: [src/commands/sync-upload-data.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/sync-upload-data.js)_
...
_See code: [src/commands/take-snapshot.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/take-snapshot.js)_
...
_See code: [src/commands/transform-field.js](https://github.com/saltcorn/saltcorn/blob/v1.5.6/packages/saltcorn-cli/src/commands/transform-field.js)_
<!-- commandsstop -->
