...
describe("Fieldview config", () => {
  ...
  it("should return fieldview options", async () => {
    ...
    await request(app)
      .get("/field/fieldviewcfgform/books/pages/progress_bar")
      .set("Cookie", loginCookie)
      .expect(
        toInclude(
          `<div class="form-group row" style="display: none;" data-show-if="e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dtype%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'Field'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfield_name%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'pages'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfieldview%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'progress_bar'"><div class="col-sm-2 text-end"><label for="inputmax">max</label></div><div class="col-sm-10"><input type="number" class="form-control  " data-fieldname="max" name="max" id="inputmax" step="1" required></div></div><div class="form-group row" style="display: none;" data-show-if="e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dtype%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'Field'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfield_name%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'pages'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfieldview%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'progress_bar'"><div class="col-sm-2 text-end"><label for="inputbar_color">Bar color</label></div><div class="col-sm-10"><input type="color" class="form-control  " data-fieldname="bar_color" name="bar_color" id="inputbar_color"></div></div><div class="form-group row" style="display: none;" data-show-if="e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dtype%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'Field'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfield_name%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'pages'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfieldview%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'progress_bar'"><div class="col-sm-2 text-end"><label for="inputbg_color">Background color</label></div><div class="col-sm-10"><input type="color" class="form-control  " data-fieldname="bg_color" name="bg_color" id="inputbg_color"></div></div><div class="form-group row" style="display: none;" data-show-if="e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dtype%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'Field'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfield_name%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'pages'%20%26%26%20e.data(%22data-closest-form-ns%22).find('%5Bdata-fieldname%3Dfieldview%5D%3Anot(%3Adisabled)').val()%3D%3D%3D'progress_bar'"><div class="col-sm-2 text-end"><label for="inputpx_height">Height in px</label></div><div class="col-sm-10"><input type="number" class="form-control  " data-fieldname="px_height" name="px_height" id="inputpx_height" step="1"></div></div>`
        )
      );
  });
});
