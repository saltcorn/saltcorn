  ...
  s.sortableLists(l.listOptions),
    ...
    (this.update = function () {
      ...
      if (null !== e) {
        ...
        i.find(".item-menu").each(function () {
          ...
          e.children().children("i").removeClass(t).addClass(e.data("icon")).text(e.data("icon").startsWith("unicode") ? String.fromCharCode(parseInt(e.data("icon").substring(8,12), 16)): ""),
    ...
    (this.add = function () {
      ...
      var t = u(),
        ...
        n = $("<i>").addClass(e.icon).text(e.icon.startsWith("unicode") ? String.fromCharCode(parseInt(e.icon.substring(8,12), 16)): ""),
        o = $("<div>")
          .css({ overflow: "auto" })
          .append(n)
          .append("&nbsp;")
          ...
          return (
            $.each(t, function (t, s) {
              ...
              var c = $("<div>").css("overflow", "auto"),
                d = $("<i>").addClass(s.icon).text(s.icon.startsWith("unicode") ? String.fromCharCode(parseInt(s.icon.substring(8,12), 16)): ""),
                p = $("<span>")
                  .addClass("txt")
